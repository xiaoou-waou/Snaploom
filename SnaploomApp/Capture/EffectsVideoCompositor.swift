...
final class EffectsVideoCompositor: NSObject, AVVideoCompositing {
    ...
    private let contextQueue = DispatchQueue(label: "Snaploom.effects.context")
    private let renderQueue = DispatchQueue(label: "Snaploom.effects.render", qos: .userInitiated)
