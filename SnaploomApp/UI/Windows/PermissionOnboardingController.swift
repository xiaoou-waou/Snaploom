...
class PermissionOnboardingController: NSWindowController {
    ...
    init() {
        ...
        window.title = L("Welcome to Snaploom")
        window.center()
    ...
    private func buildUI() {
        ...
        // Title
        let title = NSTextField(labelWithString: L("Snaploom needs one permission"))
    ...
    @objc private func openSettings() {
        ...
        // macOS will add Snaploom to the list automatically when it first
        ...
        statusLabel?.stringValue = L("Enable Snaploom, then try taking a screenshot")
    }
